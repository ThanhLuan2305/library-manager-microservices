package com.project.libmanage.book_service.security;
...
public class CustomDecoder implements JwtDecoder {
    ...
    private final AuthFeignClient authFeignClient; // Feign client for authentication service
    ...
    public Jwt decode(String token) throws JwtException {
        try {
            ...
            LoginDetailResponse loginDetail = authFeignClient.getLoginDetail(jwtID);
            if (loginDetail == null) {
